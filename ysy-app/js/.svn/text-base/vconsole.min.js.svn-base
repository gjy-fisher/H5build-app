 ...
 * 
 * https://github.com/Tencent/vConsole/blob/dev/doc/a_doc_index_CN.md
 * var vConsole = new VConsole(option);
 * vConsole.log('foo');   // 白底黑字
 * vConsole.info('bar');  // 白底紫字
 * vConsole.debug('oh');  // 白底黄字
 * vConsole.warn('foo');  // 黄底黄字
 * vConsole.error('bar'); // 红底红字
 * 
 * console.log('UserID:', 233); // 打印出 UserID: 233
